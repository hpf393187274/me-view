<template>
  <div class="demo-block">
    <div class="demo-block-source">
      ...
      <span @click="showCode=!showCode" class="demo-block-code-icon" v-if="!$slots.default">
        <img alt="expand code" class="code-expand-icon-show" src="https://gw.alipayobjects.com/zos/rmsportal/wSAkBuJFbdxsosKKpqyq.svg">
      </span>
    </div>
